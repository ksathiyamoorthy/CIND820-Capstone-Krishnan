...
plot(t(Data[1,]), t(Data[6,]),  
     xlab="Year", ylab="African Economy", type="o", col="blue")
par(new=TRUE)
lines(t(Data[1,]), t(Data[8,]), col="green")
par(new=TRUE)
lines(t(Data[1,]), t(Data[9,]), col="yellow")
par(new=TRUE)
lines(t(Data[1,]), t(Data[10,]), col="red")
par(new=TRUE)
lines(t(Data[1,]), t(Data[11,]), col="magenta")

# Add a legend
legend("topleft", legend=c("Northern", "Eastern","Middle", "Southern","Western" ),
